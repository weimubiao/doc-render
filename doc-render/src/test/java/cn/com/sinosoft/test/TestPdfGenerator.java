...
import cn.com.sinosoft.app.pdf.bean.TestFreemarkerBean;
...
//		assertTrue("pdf生成文件大小错误", file.getFreeSpace()>178000);
    ...
    public void test(String outputFile) throws DocumentGeneratingException {
        ...
        List<TestFreemarkerBean> list = new ArrayList<TestFreemarkerBean>();
        list.add(new TestFreemarkerBean("乔治1","123456","男","wwwwwwww"));
        list.add(new TestFreemarkerBean("乔治2", "123456", "男", "wwwwwwww"));
        list.add(new TestFreemarkerBean("乔治w", "123456", "男", "wwwwwwww"));
        ...
        // 生成pdf
        pdfGenerator.generate(template, overseaVo, overseaVo, outputFile);
